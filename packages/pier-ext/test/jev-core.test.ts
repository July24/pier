/**
 * jev decision layer, pure core (RFC docs/rfc-jev-integration.md): strict answer parsing, the
 * decisions/synthesis of all three call sites, and the P0-3 guard that a missing `middle` window
 * still renders the legacy observation placeholder byte for byte.
 */
...
import {
  ...
  excerptPickRequest, isDiagnosticGateUnanswered, noticeRankRequest, parseJevAnswers, type JevAnswer,
