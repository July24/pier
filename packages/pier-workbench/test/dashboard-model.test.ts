...
const SAMPLE_SNAPSHOT: SessionSnapshotData = {
  ...
  panes: [
    {
      pane_id: 'wD:p1', workspace_id: 'wD', tab_id: 'wD:t1', agent: 'pi', display_agent: 'master',
      agent_status: 'working', focused: true, tokens: { 'pi-todo': '▶1 ○2 ■0 ✓1 · Building dashboard' },
    },
    {
      pane_id: 'wD:p2', workspace_id: 'wD', tab_id: 'wD:t2', agent: 'pi', display_agent: 'worker',
      agent_status: 'blocked', title: 'Waiting for auth input', tokens: { 'lock-1234': 'locked-file' },
    },
    {
      pane_id: 'wA:p1', workspace_id: 'wA', tab_id: 'wA:t1', agent: 'pi', display_agent: 'master',
      agent_status: 'idle',
    },
  ],
};
...
test('composeDashboardLines: Herdr 0.9.1 terminal_title_stripped and foreground_cwd display', () => {
  const snapshot = {
    ...
    panes: [
      {
        pane_id: 'w1:p1', workspace_id: 'w1', tab_id: 'w1:t1', agent: 'shell',
        title: '⠋ npm test --watch', terminal_title_stripped: 'npm test --watch',
      },
